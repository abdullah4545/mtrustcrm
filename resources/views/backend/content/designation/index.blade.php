...
@section('title')
{{ ($business?->business_name ?? 'Medi Trust Solution') }} - Designations
@endsection
        ...
        <div class="card">
            <div class="card-body">
                ...
                <div class="table-responsive">
                    <table class="table table-bordered" id="designationTable" style="width:100%">
                        <thead>
                            <tr>
                                <th>#</th>
                                <th>Title</th>
            ...
            <div class="modal-body">
                ...
                <form id="designationForm">
                    ...
                    <div class="mb-2">
                        ...
                        <input type="text" id="title" class="form-control" placeholder="Designation name">
                    </div>
...
const ROUTE_DATATABLE = "{{ route('designations.datatable') }}";
const ROUTE_STORE     = "{{ route('designations.store') }}";
const ROUTE_SHOW      = "{{ url('designations') }}";
const ROUTE_UPDATE    = "{{ url('designations') }}";
const ROUTE_DELETE    = "{{ url('designations') }}";
