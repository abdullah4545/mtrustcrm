...
@section('title')
    {{ ($business?->business_name ?? 'Medi Trust Solution') }} - Organization Types
@endsection
        ...
        <div class="card">
            <div class="card-body">
                ...
                <div class="table-responsive">
                    <table class="table table-bordered" id="orgTypesTable" style="width:100%">
                        <thead>
                        <tr>
                            <th>#</th>
                            <th>Name</th>
...
@push('modals')
    {{-- Modal --}}
    <div class="modal fade" id="orgTypeModal" tabindex="-1" aria-hidden="true">
...
<script>
const ROUTE_DATATABLE = "{{ route('org.types.datatable') }}";
const ROUTE_STORE     = "{{ route('org.types.store') }}";
const ROUTE_SHOW      = "{{ url('organization/types') }}";
const ROUTE_UPDATE    = "{{ url('organization/types') }}";
const ROUTE_DELETE    = "{{ url('organization/types') }}";

let table, modal;

$(document).ready(function(){

    modal = new bootstrap.Modal(document.getElementById('orgTypeModal'));

    table = $('#orgTypesTable').DataTable({
        processing:true,
        serverSide:true,
