...
@section('title')
    {{ ($business?->business_name ?? 'Medi Trust Solution') }} - Brands
@endsection
...
const ROUTE_DATATABLE = "{{ route('brands.datatable') }}";
const ROUTE_STORE     = "{{ route('brands.store') }}";
const ROUTE_SHOW      = "{{ url('products/brands') }}";
const ROUTE_UPDATE    = "{{ url('products/brands') }}";
const ROUTE_DELETE    = "{{ url('products/brands') }}";
