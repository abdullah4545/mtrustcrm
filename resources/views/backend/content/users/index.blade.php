...
@media(max-width:767.98px){.user-head{align-items:flex-start;flex-direction:column}.user-head .btn{width:100%}.modal-dialog{max-width:none}.modal-content{max-height:calc(100dvh - .7rem)}.modal-footer{position:sticky;bottom:0;background:white;z-index:4}.dataTables_wrapper .dataTables_filter input{width:180px!important}.card-body{padding:14px}.area-row .form-select{min-height:46px}.table-responsive{overflow-x:auto;-webkit-overflow-scrolling:touch}}
</style>
